...
To address these issues, I will experiment with using a plate with smaller well sizes and record videos of the wells to image movement 'globally', capturing all active rotifers at once to reduce the risk of double-counting or missing individuals. Recording a few seconds of video of each well would only take around 2 minutes---much shorter than counting each well individually. 

### Results

Below is a figure describing change in activity at three temperature points beyond room temperature (27.5, 30, 35 C). Note the high standard error, likely due to the two issues addressed above.
...
```{r ctmax, include=TRUE, echo=TRUE}
...
finalVolume2 = 0.1      # stock culture volume, mL
